    ...
    <div class="container" v-if="currentWeather">
      <div class="weather-info">
        <span class="city"
          ...
          {{ this.currentWeather.sys.country }}</span
        >
        ...
        <div class="high-low-temperatures">
          <div class="high">
            ...
            <span
              >{{
                Math.round(this.currentWeather.main.temp_max) + 1
              }}&deg;</span
            >
          </div>
          <div class="low">
            ...
            <span
              >{{
                Math.round(this.currentWeather.main.temp_min) - 1
              }}&deg;</span
            >
          </div>
        </div>
...
//v-if="currentWWeather" có dữ liệu sẽ render view không sẽ lỗi axios(promise) khi cố truy cập dữ liệu
</script>
